    ...
    <section id="features" className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div
          ...
          className={`text-center mb-12 md:mb-20 space-y-4 md:space-y-6 transition-all duration-700 ${headerAnimation.isVisible
        ...
        >
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className={`group relative transition-all duration-700 ${cardsAnimation.isVisible
                ? 'opacity-100 translate-y-0'
                : 'opacity-0 translate-y-10'
                }`}
              style={{
        ...
        <div
          ...
          className={`mt-16 md:mt-20 text-center transition-all duration-700 ${ctaAnimation.isVisible
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-10'
            }`}
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-6 sm:p-8 rounded-2xl glass-effect-strong border border-border/50 shadow-xl max-w-3xl mx-auto">
            ...
            <button
              ...
              className="btn btn-gradient btn-lg whitespace-nowrap px-8 py-3 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/35"
            >
              Try It Now
            </button>
          </div>
        ...
        <div
          ...
          className={`grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mt-12 md:mt-16 transition-all duration-700 ${statsAnimation.isVisible
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-10'
            }`}
        >
